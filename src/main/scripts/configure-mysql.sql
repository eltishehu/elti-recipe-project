...
#if you're running on a docker, add these 2 also
CREATE USER 'sfg_dev_user'@'%' IDENTIFIED BY 'elti';
CREATE USER 'sfg_prod_user'@'%' IDENTIFIED BY 'elti';
...
#if you're running on a docker, add these 8 also
